...
const Home = (props) => {
  ...
  const handleLogin = () => {
    window.location = `${SPOTIFY_AUTHORIZE_URL}?client_id=${SPOTIFY_CLIENT_ID}&redirect_uri=${CALLBACK_URL}&scope=user-read-recently-played%20user-top-read%20user-read-private&response_type=token&show_dialog=true`;
  };
